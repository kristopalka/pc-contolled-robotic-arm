...
namespace RoboticArm
{
    public partial class Settings : Form
    {
        ...
        private bool IsAutorun()
        {
            ...
            if (rkApp.GetValue(RoboticArm.Properties.Resources.AppName) == null) return false;
            else return true;
        }
        ...
        private void IsAutorun_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                RegistryKey rkApp = Registry.CurrentUser.OpenSubKey("SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Run", true);
                rkApp.DeleteValue(RoboticArm.Properties.Resources.AppName, false);
            }
            else
            {
                RegistryKey rkApp = Registry.CurrentUser.OpenSubKey("SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Run", true);
                rkApp.SetValue(RoboticArm.Properties.Resources.AppName, Application.ExecutablePath.ToString());
            }
        }
    }
}
